...
<head>
    ...
    {!! OpenGraph::generate() !!}
    <link rel="stylesheet" id="style-css" href="{{ asset('comics/css/style-reader.css') }}" type="text/css"
        media="all" />
    <link rel="stylesheet" id="lightstyle-css" href="{{ asset('comics/css/lightmode.css') }}" type="text/css"
        media="all" />
    ...
    <!-- Google tag (gtag.js) -->
    <script async src="https://www.googletagmanager.com/gtag/js?id=G-9X83F02ZGL"></script>
    <script>
    ...
    <script async src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js?client=ca-pub-2394314030931134"
...
<body class="darkmode" itemscope="itemscope" itemtype="http://schema.org/WebPage">
    ...
    <link rel="stylesheet" id="owl-carousel-css" href="{{ asset('comics/css/owl.carousel.css') }}" type="text/css"
        media="all" />
    <script type="text/javascript" src="{{ asset('comics/js/owl.carousel.js') }}" id="owl-carousel-js"></script>
    <script>
        console.clear();
    </script>
