                    ...
                    <div class="bixbox">
                        ...
                        <div class="listupd stsven">
                            ...
                            @if ($isLastPage == false)
                                <div class="hpage">
                                    @if ($page != 1)
                                        <a href="{{ route('reader.genre.page', ['slug' => $slug, 'page' => $previousPage]) }}"
                                            class="r"><i class="fa fa-chevron-left" aria-hidden="true"></i> Kembali</a>
                                    @endif
                                    <a href="{{ route('reader.genre.page', ['slug' => $slug, 'page' => $nextPage]) }}"
                                        class="r">Lanjut <i class="fa fa-chevron-right" aria-hidden="true"></i></a>
                                </div>
                            @else
                                <div class="hpage">
                                    @if ($page != 1)
