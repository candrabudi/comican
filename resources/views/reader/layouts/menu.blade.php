    ...
    <div class="centernav bound">
        ...
        <header role="banner" itemscope itemtype="http://schema.org/WPHeader">
            <div class="site-branding logox">
                <span class="logos">
                    <a title="Seataku - Baca Komik Terlengkap dan Terbaru Hari Ini" itemprop="url" href="{{ route('reader') }}">
                        <img data-lazyloaded="1" data-placeholder-resp="195x50"
                            src="{{ asset('mangareader/images/komiksea.png') }}"
                            data-src="{{ asset('mangareader/images/komiksea.png') }}" width="195"
