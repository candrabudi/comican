            ...
            <div class="site-branding logox">
                <span class="logos">
                    <a title="Seataku - Baca Komik Terlengkap dan Terbaru Hari Ini" itemprop="url"
                        href="https://seataku.com/"><img data-lazyloaded="1" data-placeholder-resp="195x50"
                            src="{{ asset('reader/images/komiksea.png') }}"
                            data-src="{{ asset('reader/images/komiksea.png') }}" width="195"
                            height="50" alt="Seataku - Baca Komik Terlengkap dan Terbaru Hari Ini"><span
                            class="hdl">Komiksea</span></a>
                </span>
                <meta itemprop="name" content="Komiksea - Tempat Baca Komik Online Bahasa Indonesia" />
            </div>
        </header>
            ...
            <span itemscope="itemscope" itemtype="http://schema.org/SiteNavigationElement" role="navigation">
                <ul id="menu-manga" class="menu">
                    <li id="menu-item-8"
                        ...
                        <a href="/" aria-current="page" itemprop="url"><span itemprop="name">Home</span></a>
                    </li>
                    <li id="menu-item-9" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-9"><a
                            href="/manga" itemprop="url"><span itemprop="name">Manga List</span></a></li>
                    <li id="menu-item-10" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-10">
                        <a href="/bookmark" itemprop="url"><span itemprop="name">Bookmark</span></a></li>
                </ul>
            </span>
            <div class="clear"></div>
        </nav>
